...
class Lohnsteuer2014 implements LohnsteuerInterface {
	...
	/** Neuer Wert  2014 */
	protected static final $RENTBEMESSUNGSGR_OST = new BigDecimal(60000);

	/** Rentenbemessungs-Grenze alte Bundesländer in EUR */

	/** Neuer Wert 2014 */
	protected static final $RENTBEMESSUNGSGR_WEST = new BigDecimal(71400);
	...
	protected function UPEVP() {
		...
		if($KRV > 1) {
			...
			if($KRV == 0) {/** Neuer Wert 2014 */
				...
				if($ZRE4VP->compareTo(self::$RENTBEMESSUNGSGR_OST) == 1) {
					$ZRE4VP = self::$RENTBEMESSUNGSGR_OST;
				}
			}/** Neuer Wert 2014 */
